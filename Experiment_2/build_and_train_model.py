...
def main():
    ...
    DATA_PATH = "/Volumes/thesis_drive/spectrogram_data_train/"
    LABELS_PATH = "/Volumes/thesis_drive/spectrogram_labels_train/"
    BATCH_SIZE = 64
    ...
    EPOCHS = 20
    OUTPUT_PATH = "/Volumes/thesis_drive/Experiment_2/trained_model/"
