...
def main():
    ...
    x = Dropout(0.5)(x)
    x = Conv2D(filters=128, kernel_size=4, input_shape=(64,320,1), data_format="channels_last")(x)
    x = Activation('relu')(x)
    x = MaxPooling2D(pool_size=(4, 4))(x)
    x = Dropout(0.5)(x)
    x = Conv2D(filters=256, kernel_size=4, input_shape=(32,160,1), data_format="channels_last")(x)
    x = Activation('relu')(x)
